        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_HomeNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image_Ext = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Image_Data = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Polaroids", x => new { x.OrderId, x.Id });
                    table.ForeignKey(
                        name: "FK_Polaroids_Orders_OrderId",
                        column: x => x.OrderId,
